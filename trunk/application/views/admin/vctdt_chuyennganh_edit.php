...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo static_url(); ?>/css/admin/ctdt_chuyennganh_edit.css" />
    ...
    <script type="text/javascript" src="<?php echo static_url(); ?>/js/admin/jctdt_chuyennganh_edit.js"></script>        
    ...
    <div id="data">
        ...
        <div id="right">
            ...
            <div id="content">
                ...
                <table id="thongtin">
                <tr>
                <td id='tencn' class='<?php echo $macn; ?>' >Chuyên Ngành:<b> <?php echo $tencn; ?></b></td>
                <td id='tenkhoa' class='<?php echo $khoa; ?>' >Khoa:<b> <?php echo $tenkhoa; ?></b></td>
                <td id='k' class='<?php echo $k; ?>' >Khóa: <b><?php echo $k; ?></b></td>                
