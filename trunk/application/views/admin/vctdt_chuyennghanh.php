...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo static_url(); ?>/css/admin/ctdt_chuyennghanh.css" />
    ...
    <script type="text/javascript" src="<?php echo static_url(); ?>/js/admin/jctdt_chuyennghanh.js"></script>        
    ...
    <div id="data">
        ...
        <ul>
            ...
            {   
                $makhoa=$row->MaKhoa;
                $tenkhoa=$row->TenKhoa;
               echo "<li id='$makhoa' title='$tenkhoa'><a href='/quanly/chuong-trinh-dao-tao/$makhoa'> Khoa $makhoa</a></li>"; 
            }
                echo "</ul>";
            ...
            { 
                ...
                echo "<li class='active' id='$makhoa' title='$tenkhoa'><a href='/quanly/chuong-trinh-dao-tao/chuyen-nghanh/$makhoa'> Khoa $makhoa</a></li>";  
                else echo "<li id='$makhoa' title='$tenkhoa'><a href='/quanly/chuong-trinh-dao-tao/chuyen-nghanh/$makhoa'> Khoa $makhoa</a></li>";  
            }
                echo "</ul>";
            ?>
