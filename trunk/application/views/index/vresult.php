...
<head>
	...
	<link href="<?php echo static_url();?>/css/index/result.css" rel="stylesheet" type="text/css" />
	<script type="text/javascript" src="<?php echo static_url();?>/js/jquery.min.js"></script>
	<script type="text/javascript" src="<?php echo static_url();?>/js/index/vresult.js"></script>
                ...
                <div id="contenttable" class="box_data">
                    <table>
						...
						<tr>
							...
							<td colspan="7"><? echo $sotc; ?></td>
						</tr>
                    </table>
                </div><!-- end #contenttable -->
				
				<div id="contenttable1">
					<button id="inphieu">In phiếu</button>
					<button id="suadk">Sửa đăng ký</button>
